...
class CheckoutSession:
    ...
    async def _execute_negotiations(self, session, graphql_url, subtotal):
        ...
        # --- THE ULTIMATE FIX: COMBINING BOTH APPROACHES ---
        # We strictly parse and lock onto the finalized totals returned after applying the delivery method.
        # This ensures the exact, cent-perfect amount is submitted to the card processor.
        try:
            resp_json = json.loads(text)
            result = resp_json.get('data', {}).get('session', {}).get('negotiate', {}).get('result', {})
            seller_proposal = result.get('sellerProposal', {})
            ...
            final_delivery = seller_proposal.get('delivery', {})
            ...
            final_tax = seller_proposal.get('tax', {})
