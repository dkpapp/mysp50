...
class CheckoutSession:
    ...
    async def run(self, session: aiohttp.ClientSession):
        ...
        # Fix INVALID_VARIABLE strict typing by avoiding "" which validates string schema checks instead of being null
    ...
    async def _execute_negotiations(self, session, graphql_url, subtotal):
        ...
        base_json = {
            ...
            'variables': {
                ...
                # REMOVED: 'deliveryExpectations' as it's not declared in Proposal mutation arguments.
                'merchandise': {
                    'merchandiseLines': [{
                ...
                'payment': {
                    ...
                    'billingAddress': {
                        'streetAddress': {
                            ...
                            'lastName': '', 'zoneCode': self.state, 'phone': ''  # Corrected hardcoded ENG zone
                        }
                    }
                },
                'buyerIdentity': {
